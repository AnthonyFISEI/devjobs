<aside class="md:w-2/5 bg-teal-500 p-5 rounded m-3">
    ...
    <form enctype="multipart/form-data" action="{{route('candidatos.store')}}" method="POST">
        ...
        <div class="mb-4">
            ...
            class="p-3 bg-gray-100 rounded form-input w-full @error('nombre') border border-red-500
            @enderror"
            name="nombre"
        ...
        <div class="mb-4">
            ...
            class="p-3 bg-gray-100 rounded form-input w-full @error('email') border border-red-500
            @enderror"
            name="email"
        ...
        <div class="mb-4">
            ...
            class="p-3 rounded form-input w-full @error('cv') border border-red-500
            @enderror"
            name="cv"
        ...
        <input type="submit"
            class="bg-teal-600 w-full hover:bg-teal-700 text-gray-100 p-3
            focus:outline-none focus:shadow-outline uppercase"
            value="contactar">
